...
class ConvEncoder(nn.Module):
    ...
    def __init__(self, in_size=1024, out_size=1024, hop_size=384, exp_settings={}):
        ...
        self.conv_a1 = torch.nn.Conv1d(in_channels=1 if self.monaural else 2, out_channels=self.sz_out,
    ...
    def forward(self, wave_form):
        ...
        time_domain_samples = wave_form.shape[-1]
        # Reshaping
        wave_form = wave_form.view(batch_size, 1 if self.monaural else 2, time_domain_samples)
        # Cosine part
